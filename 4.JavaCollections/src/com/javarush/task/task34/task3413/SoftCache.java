...
public class SoftCache {
    ...
    public AnyObject get(Long key) {
        SoftReference<AnyObject> softReference = cacheMap.get(key); //получаем ссылку по ключу
        if (cacheMap.containsKey(key)) //проверяем существует ли ключ
            return softReference.get(); //если существует, во возвращаем ссылку по ключу
        else return null;
